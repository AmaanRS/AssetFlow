const PERMISSIONS = {
  ...
  READ_USER: "read:user",
  READ_USER_DIRECTORY: "read:user-directory",
  UPDATE_USER: "update:user",
  DELETE_USER: "delete:user",
  MANAGE_DEPARTMENT: "manage:department",
  MANAGE_CATEGORY: "manage:category",
  MANAGE_AUDIT: "manage:audit",
  VERIFY_AUDIT_ASSET: "verify:audit-asset",
...
const roles = {
  Employee: {
    ...
    permissions: [
      ...
      PERMISSIONS.READ_USER_DIRECTORY,
      ...
      PERMISSIONS.VERIFY_AUDIT_ASSET,
    ],
  },
  DepartmentHead: {
    inherits: ["Employee"],
